...
cart.forEach((cartItem) => {
  ...
  cartSummaryHTML += `
  <div class="cart-item-container js-cart-item-container-${matchingProduct.id} js-item-container">
            ...
            <div class="cart-item-details-grid">
              ...
              <div class="cart-item-details">
                ...
                <div class="product-quantity js-product-quantity-${matchingProduct.id}">
                  ...
                  <span class="delete-quantity-link link-primary js-delete-link" data-quantity-link="${matchingProduct.id}">
                    Delete
                  </span>
                </div>
              </div>
...
document.querySelectorAll('.js-delete-link').forEach((link) =>{
  link.addEventListener('click', () => {
    let productId = link.dataset.quantityLink;
